...
public:
	...
	void createBlocksTable(DB *db);
	void addBlock(DB *db, Reservation *re, int roomNumber, Date *d);
	void deleteBlock(DB *db, Reservation *re, int roomNumber, Date *d);
	void getBlock(DB *db, Reservation *re, Room *ro, Date *d);
