...
public:
	...
	reservationIter findReservation(string name);
	...
	bool addAccount(Accounts& newAccount);

	bool deleteAccount(const string& newName);
	...
	bool modifyAccount(Accounts& modifiedAccount);

	accountsIter findAccount(const string& newName);

	accountsIter findAccountByUsername(const string& username);

	accountsIter getAccountsBegin();
	
	accountsIter getAccountsEnd();

	bool accountExists(const string& newName);

	bool accountExistsByUsername(const string& username);

	vector<RoomType*> getAllRoomTypes() const;
	vector<Room*> getAllRoom() const;
	list<Reservation*> getCalendarArray();
