...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->comboBox1->Location = System::Drawing::Point(127, 416);
			...
			this->comboBox2->Location = System::Drawing::Point(127, 461);
			this->comboBox2->Name = L"comboBox2";
			this->comboBox2->Size = System::Drawing::Size(204, 21);
...
private: System::Void saveReservationButton_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 CreditCard *credCard = new CreditCard(marshal_as<std::string>(this->nameInputTextbox->Text->ToString()),
												   ...
												   "test",
												   marshal_as<std::string>(this->comboBox2->Text->ToString()));
			 credCard->print();
